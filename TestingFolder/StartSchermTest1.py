...
def Startscherm_prog():
    ...
    def main():
        ...
        while True: #and not start_missie
            for event in pygame.event.get():
                if (event.type == pygame.QUIT): # or (start_missie)
                    pygame.quit()
                    print("stop startscherm")
                    sys.exit()
                    print("stop startscherm")
    ...
    #    main()
    #met de if werkte het programma niet meer, idk wrm
            
    #return de gekozen rol
    gekozen_rol = main()
    return gekozen_rol